...
/**
 * Tests the argument parser for simple flagged arguments
 */
@RunWith(value = Parameterized.class)
public class ArgumentParser_FlaggedArgument_Test {
	...
	public ArgumentParser_FlaggedArgument_Test(int step, int parameterCount, int position, boolean invalid, String[] arguments, String[] resultParams) {
		this.step = step;
